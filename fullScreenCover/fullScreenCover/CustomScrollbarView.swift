...
//        max(50, containerHeight * (containerHeight / contentHeight))
//    }
//
...
//        return progress * maxScrollbarMovement
//    }
//
//    var body: some View {
...
//                .frame(width: 6, height: scrollbarHeight)
//                .offset(y: min(scrollbarPosition, maxScrollbarMovement)) // Limits movement to 100px
